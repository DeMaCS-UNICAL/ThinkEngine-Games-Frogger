...
trunkUP(X,Z):-playerPos(X,Z),trunk(X,Z1),Z1>Z;
trunkDOWN(X,Z):-playerPos(X,Z),trunk(X,Z1),Z1<Z;

nextPlayerPos(T,X,Z,P,still):-playerPos(X,Z),P=null.
nextPlayerPos(T,X,Z1,P,up):-playerPos(X,Z), Z1=Z+1,P=null.
nextPlayerPos(T,X,Z1,P,down):-playerPos(X,Z),Z1=Z-1,P=null.
nextPlayerPos(T,X1,Z,P,left):-playerPos(X,Z), X1=X-1,P=null.
nextPlayerPos(T,X1,Z,P,right):-playerPos(X,Z), X1=X+1,P=null.
